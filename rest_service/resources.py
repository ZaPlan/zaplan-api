...
class Root(Resource):
    def get(self):
        return {"Welcome"  : "This is the Zaplan API", "Sample Query:" : "http://127.0.0.1:5000/timeline?latitude=12.844413099999999&longitude=80.1524191&budget=1500&radius=100000&start_time=9&end_time=22"}
